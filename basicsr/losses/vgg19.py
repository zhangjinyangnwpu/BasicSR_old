...
def oook():
    ...
    net = ContrastLoss()
    anchor = torch.rand((10, 3, 128, 128), dtype=torch.float32).cuda()
    pos = torch.rand((10, 3, 128, 128), dtype=torch.float32).cuda()
    neg = torch.rand((10, 3, 128, 128), dtype=torch.float32).cuda()
